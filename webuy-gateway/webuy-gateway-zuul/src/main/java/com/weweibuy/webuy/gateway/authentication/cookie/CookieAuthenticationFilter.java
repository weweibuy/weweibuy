package com.weweibuy.webuy.gateway.authentication.cookie;

import com.weweibuy.webuy.gateway.authentication.IAuthenticationEntryPoint;
import com.weweibuy.webuy.gateway.authentication.exception.CookieAuthenticationInvalidException;
import com.weweibuy.webuy.gateway.model.JwtToken;
...
public class CookieAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(authentication != null){
            ...
            try {
                ...
                removeCookieAuthentication(request, response);
    ...
    private void removeCookieAuthentication(HttpServletRequest request, HttpServletResponse response){
        Cookie[] cookies = request.getCookies();
        for(Cookie cookie : cookies){
            if(cookie.getName().equals("Authorization")){
                cookie.setMaxAge(0);

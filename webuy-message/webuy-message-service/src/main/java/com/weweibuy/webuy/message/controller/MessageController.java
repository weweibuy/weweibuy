...
public class MessageController {
    ...
    public CommonDataJsonResponse<MessageDto> saveMessage(@RequestBody @Validated PreSaveMessageVo message) {
        return CommonDataJsonResponse.success(messageService.preSaveMessage(message));
    }
    ...
    public CommonDataJsonResponse<MessageDto> sendMessage(@RequestBody @Validated ConfirmMessageVo confirmMessageVo) {
        WebuyMessage message = messageService.sendMessage(confirmMessageVo);
        return CommonDataJsonResponse.success(MessageDto.conventPoToDto(message));
    }
    ...
    public CommonDataJsonResponse<MessageDto> reSendMessage(@RequestBody @Validated ConfirmMessageVo confirmMessageVo) {
    ...
    public CommonDataJsonResponse deleteBizFailMessage(@RequestBody @Validated ConfirmMessageVo confirmMessageVo) {
        messageService.deleteBizFailMessage(confirmMessageVo);
        return CommonDataJsonResponse.success(confirmMessageVo);
    }
    ...
    public CommonDataJsonResponse<MessageDto> confirmMessage(@RequestBody @Validated ConfirmMessageVo confirmMessageVo) {
        messageService.confirmMessage(confirmMessageVo);
        return CommonDataJsonResponse.success(new MessageDto());
    }
    ...
    public CommonCodeJsonResponse getMessageByDeliverTag(@ApiParam(name = "消息id") @PathVariable Long id,
        ...
        return message != null ? CommonDataJsonResponse.success(MessageDto.conventPoToDto(message)) :
                CommonCodeJsonResponse.badRequestParam("");
    }
    ...
    public CommonCodeJsonResponse getMessages(@ApiParam(name = "起始页数") @PathVariable Integer page,
                                              @ApiParam(name = "每页条数") @PathVariable Integer row) {
        return CommonDataJsonResponse.success(MessageDto.conventListPoToDto(messageService.selectPageListWhereNotConfim(page, row)));
    }
    ...
    public CommonCodeJsonResponse getDeadMessage(@ApiParam(name = "起始页数") @PathVariable Integer page,
                                                 @ApiParam(name = "每页条数") @PathVariable Integer row) {
        return CommonDataJsonResponse.success(MessageDto.conventListPoToDto(messageService.selectPageListWhereIsDead(page, row)));
    }
    ...
    public CommonCodeJsonResponse reSendDeadMessage(@RequestBody @Validated ConfirmMessageVo confirmMessageVo) {

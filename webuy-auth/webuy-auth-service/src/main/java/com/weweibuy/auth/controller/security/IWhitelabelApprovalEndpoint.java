package com.weweibuy.auth.controller.security;

import com.weweibuy.auth.view.security.ISpelView;
...
/**
 * 重新oauth2授权确认页
 * @ClassName IWhitelabelApprovalEndpoint
 * @Description
 * @Author durenhao
 * @Date 2018/12/30 23:12
 **/
@SessionAttributes({"authorizationRequest"})
public class IWhitelabelApprovalEndpoint {
    ...
    public IWhitelabelApprovalEndpoint() {
    }
...
//    @RequestMapping({"/oauth/confirm_access"})
    public ModelAndView getAccessConfirmation(Map<String, Object> model, HttpServletRequest request) throws Exception {
        ...
        return new ModelAndView(new ISpelView(template), model);
    }
